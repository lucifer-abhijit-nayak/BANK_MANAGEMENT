...

{
    ...
    account_no:
    system("cls");
    printf("\t\t\t\xB2\xB2\xB2\ NEW RECORD  \xB2\xB2\xB2\xB2");
...
{   int choice;
    ...
    printf("\n\n\n\t\t\t\t\t\xB2*\xB2*\xB2*\xB2*\xB2*\xB2*\xB2*THE MAIN MENU \xB2*\xB2*\xB2*\xB2*\xB2*\xB2*\xB2");
...
int main()
{
    char pass[10],password[10]="lucifer";
    int i=0;
